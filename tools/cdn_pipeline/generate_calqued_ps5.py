...
def build_calqued_cover():
    ...
    with Image.open(io.BytesIO(raw_bytes)) as game_art:
        ...
        # 1. Artwork below header: 600 x 723
        ...
        # 2. Paste the CALQUED MASTER PS5 HEADER (600 x 77)
        header = Image.open("/Users/thebigmike/.gemini/antigravity/scratch/machete/tools/cdn_pipeline/ps5_calque_master.png").convert("RGB")
        ...
        print("🏆 100% CALQUED ORIGINAL PS5 COVER UPLOADED TO CLOUDFLARE R2!")

...
def upload_exact_re8_main_art(ppsa_id):
    # Iconic main artwork for Resident Evil Village (Chris Redfield / Lycan face)
    main_art_url = "https://image.api.playstation.com/vulcan/ap/rnd/202101/0812/DGW5xHgDXbWaEvssZRG0QeCl.png"
    print(f"Downloading main cover for {ppsa_id}: {main_art_url}")
    req = urllib.request.Request(main_art_url, headers={'User-Agent': 'Mozilla/5.0'})
    ...
    print(f"✅ Subida 4K Boxed Principal: {ppsa_id}.webp ({len(boxed_webp) // 1024} KB)")

# Upload to both PPSA01556 and PPSA01557
upload_exact_re8_main_art("PPSA01556")
upload_exact_re8_main_art("PPSA01557")

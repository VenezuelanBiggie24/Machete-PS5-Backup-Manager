...
def build_genuine_cover():
    # 1. Download official God of War Ragnarok HD artwork (PPSA08330)
    ...
    with Image.open(io.BytesIO(raw_bytes)) as game_art:
        ...
        # 1. Artwork below header: 600 x 715
        ...
        # 2. Paste Genuine PS5 Header Template (600 x 85)
        header = Image.open("/Users/thebigmike/.gemini/antigravity/scratch/machete/tools/cdn_pipeline/ps5_real_header_template.png").convert("RGB")
        resized_header = header.resize((WIDTH, HEADER_HEIGHT), Image.Resampling.LANCZOS)
        ...
        print("✅ 100% Genuine PS5 Retail Box Art generated and uploaded to Cloudflare R2!")
